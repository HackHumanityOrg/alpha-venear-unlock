/**
 * Test: agoraeng3.near - Simple unlock flow (no staking)
 *
 * Account State (from mainnet):
 * - Owner: agoraeng3.near
 * - Lockup: 2bd2d541d719b6fc9db375e843834c7a613d24fa.v.voteagora.near
 * - Locked: ~3.8 NEAR
 * - Pending: 0 NEAR
 * - Staking: None
 *
...
const OWNER_ACCOUNT = "agoraeng3.near";
const LOCKUP_CONTRACT = "2bd2d541d719b6fc9db375e843834c7a613d24fa.v.voteagora.near";
