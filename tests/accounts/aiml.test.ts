/**
 * Test: aiml.near - Already unlocking flow (no staking)
 *
 * Account State (from mainnet):
 * - Owner: aiml.near
 * - Lockup: 6173b93ecab1dce7385edb765a2744c8348578c5.v.voteagora.near
 * - Locked: 0 NEAR
 * - Pending: ~9.9 NEAR (ALREADY UNLOCKING)
 * - Staking: None
 *
 * Test Flow:
...
const OWNER_ACCOUNT = "aiml.near";
const LOCKUP_CONTRACT = "6173b93ecab1dce7385edb765a2744c8348578c5.v.voteagora.near";
