/**
 * Test: tanegov.near - Simple unlock flow (no staking)
 *
 * Account State:
 * - Owner: tanegov.near
 * - Lockup: 97e471e5dfc1e1ff951b4cfb84b8164a51beb0fc.v.voteagora.near
 * - Locked: ~2.00 NEAR
 * - Staking: None
 */
...
const OWNER_ACCOUNT = "tanegov.near";
const LOCKUP_CONTRACT = "97e471e5dfc1e1ff951b4cfb84b8164a51beb0fc.v.voteagora.near";
...
test("tanegov.near: Simple unlock flow", async (t) => {
