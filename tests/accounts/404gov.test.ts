/**
 * Test: 404gov.near - Simple unlock flow (no staking)
 *
 * Account State:
 * - Owner: 404gov.near
 * - Lockup: 1e8291a672b6e4b3ca97c867db30a6c022f9a44c.v.voteagora.near
 * - Locked: ~14.90 NEAR
 * - Staking: None
 *
 * Test Flow:
...
const OWNER_ACCOUNT = "404gov.near";
const LOCKUP_CONTRACT = "1e8291a672b6e4b3ca97c867db30a6c022f9a44c.v.voteagora.near";
