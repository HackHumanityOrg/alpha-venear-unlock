/**
 * Test: nearweek.near - Simple unlock flow (no staking)
 *
 * Account State:
 * - Owner: nearweek.near
 * - Lockup: f4e9097b0121aeb550f9f3fae152e3de36c9d27e.v.voteagora.near
 * - Locked: ~7.90 NEAR
 * - Staking: None
 */
...
const OWNER_ACCOUNT = "nearweek.near";
const LOCKUP_CONTRACT = "f4e9097b0121aeb550f9f3fae152e3de36c9d27e.v.voteagora.near";
...
test("nearweek.near: Simple unlock flow", async (t) => {
