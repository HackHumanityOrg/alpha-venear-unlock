/**
 * Test: agoraeng5.near - Simple unlock flow (no staking)
 *
 * Account State (from mainnet):
 * - Owner: agoraeng5.near
 * - Lockup: 8e3393711b9175da8155323791f4dd6191de03da.v.voteagora.near
 * - Locked: ~2.01 NEAR
 * - Pending: 0 NEAR
 * - Staking: None
 *
...
const OWNER_ACCOUNT = "agoraeng5.near";
const LOCKUP_CONTRACT = "8e3393711b9175da8155323791f4dd6191de03da.v.voteagora.near";
