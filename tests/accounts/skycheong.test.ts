/**
 * Test: skycheong.near - Simple unlock flow (no staking)
 *
 * Account State:
 * - Owner: skycheong.near
 * - Lockup: 00aae53452e9bc005333bcfab38ab6cf993e4748.v.voteagora.near
 * - Locked: ~1.00 NEAR
 * - Staking: None
 */
...
const OWNER_ACCOUNT = "skycheong.near";
const LOCKUP_CONTRACT = "00aae53452e9bc005333bcfab38ab6cf993e4748.v.voteagora.near";
...
test.beforeEach(async (t) => {
  ...
  t.context = { worker, root, lockup, factory, ownerAccount };
});
...
test("skycheong.near: Simple unlock flow", async (t) => {
