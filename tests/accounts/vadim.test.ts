/**
 * Test: vadim.near - Simple unlock flow (no staking)
 *
 * Account State:
 * - Owner: vadim.near
 * - Lockup: 9a881619b2bd37617af1255448659c5f512bc0c4.v.voteagora.near
 * - Locked: ~2.40 NEAR
 * - Staking: None
 */
...
const OWNER_ACCOUNT = "vadim.near";
const LOCKUP_CONTRACT = "9a881619b2bd37617af1255448659c5f512bc0c4.v.voteagora.near";
...
test("vadim.near: Simple unlock flow", async (t) => {
